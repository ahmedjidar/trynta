 ...
 */
retryInSeconds: number, } | { "kind": "tamperDetected" } | { "kind": "notFound" } | { "kind": "noSuchField" } | { "kind": "reauthRequired" } | { "kind": "lastVaultRemaining" } | { "kind": "clipboard" } | { "kind": "dataDirectory" } | { "kind": "featureUnavailable" } | { "kind": "storage" } | { "kind": "crypto" } | { "kind": "biometric" } | { "kind": "updateFailed" } | { "kind": "invalid" };
